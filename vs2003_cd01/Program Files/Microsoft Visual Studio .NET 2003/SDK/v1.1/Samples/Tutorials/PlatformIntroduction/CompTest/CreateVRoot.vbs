...
vNames = Array("PlatformIntroduction") ' Names of webs to create
vPaths = Array(vPath + "ClientASP") ' Paths of web to create
...
Sub CreateVDir(vNames, vPaths, vBaseName)
    ...
    ' find or create the .Net Framework SDK vroot.  This is the parent vroot for all the .Net Framework SDK samples.
