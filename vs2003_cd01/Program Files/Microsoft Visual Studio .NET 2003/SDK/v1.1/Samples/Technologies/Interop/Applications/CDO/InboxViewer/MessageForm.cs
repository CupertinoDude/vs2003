...
public class MessageForm : System.Windows.Forms.Form {
	...
	private string text;
		...
		// Required for .NET Framework Classes Designer support
		InitializeComponent();
        }

        /**
         * MessageForm overrides dispose so it can clean up the
         * component list.
         */
        ...
        private void InitializeComponent()
	{
		...
		labelSubject.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
		...
		this.Resize += new System.EventHandler(MessageForm_Resize);
	}
