...
Public Class HelloAsync2
    ...
    Public Sub Run()
        ...
        Dim ar As IAsyncResult = returnGreetingDelegateObj.BeginInvoke(name, asyncCallback, stateObject)
    ...
    Public Sub greetingCallBack(ar As IAsyncResult)
        Dim returnGreetingDelegateObj As ReturnGreetingDelegate = CType(CType(ar, AsyncResult).AsyncDelegate, ReturnGreetingDelegate)
