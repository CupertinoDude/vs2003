...
csc /target:library %DEBUGSAMPLE% /d:BuildBat /out:OPDemoSvr.dll /r:System.EnterpriseServices.dll /r:System.Windows.forms.dll  /r:system.dll /r:System.Drawing.dll OPObj.cs

@ REM compile the sample .NET client application
@ REM this build step generates a windows .exe
csc /target:winexe /out:OPDemo.exe /r:OPDemoSvr.dll /r:System.Windows.forms.dll  /r:System.dll /r:System.Drawing.dll OPForm.cs 
...
:clean
gacutil /u OPDemoSvr,PublicKeyToken=548c930b64484f46
