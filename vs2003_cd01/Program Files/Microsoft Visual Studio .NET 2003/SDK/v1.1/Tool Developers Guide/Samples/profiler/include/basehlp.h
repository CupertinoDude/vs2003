...
{   
	public:
		...
		//
		// throws an error box with the Win32 error value
		// from GetLastError
		// 
		static void PrintTheWin32Error( DWORD dwError );
        ...
        //
        // retrieve a DWORD value from the registry if it exists, return 0 otherwise
        //
		static DWORD GetEERegistryKeyDWORD( char *regKeyName );


		//
        // retrieve a String value from the registry if it exists, return NULL otherwise
        //
		static char *GetEERegistryKeySTRING( char *regKeyName );
