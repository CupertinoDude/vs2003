...
/***************************************************************************************
 ********************                                               ********************
 ********************         StackFunctionInfo Implementation      ********************
 ********************                                               ********************
 ***************************************************************************************/
 ...
 ***************************************************************************************/
/* public */
void StackFunctionInfo::Dump()
{
} // StackFunctionInfo::Dump


/***************************************************************************************
 ********************                                               ********************
 ********************        FunctionTimingInfo Implementation      ********************
 ********************                                               ********************
 ***************************************************************************************/
...
void PrfInfo::DumpTables()
{
	...
	{	   	
	    ...
	    {
			LOG_TO_FILE( ("Thread ID;Function;Times Called;Exclusive Time;Inclusive Time;Callee Time;Suspended Time;Profiler Time\n\n") )
    		m_pThreadTable->Dump();
    	}
   	}
