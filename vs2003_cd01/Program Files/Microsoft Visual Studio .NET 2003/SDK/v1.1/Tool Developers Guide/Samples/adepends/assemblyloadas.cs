...
namespace ADepends
  ...
  internal enum AssemblyLoadAs
    {
    /**
     * Use <b>AssemblyName.GetAssemblyName</b> to create AssemblyNames, and
     * use <b>Assembly.Load</b> to load the Assembly.  This causes the
     * assembly to be loaded into the Current AppDomain.
     */
    Default,

    /**
     * Load AssemblyNames via <b>AssemblyName.GetAssemblyName</b>, and
     ...
     * Load AssemblyNames by setting the <b>AssemblyName.CodeBase</b> property.
