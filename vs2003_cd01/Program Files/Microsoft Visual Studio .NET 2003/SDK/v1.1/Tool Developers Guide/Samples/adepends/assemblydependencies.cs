...
namespace ADepends
  ...
  internal class AssemblyDependencies
     ...
     * can't be loaded, an exception <b>is not</b> thrown; instead, the
     * IAssemblyInfo object returned will hold exception information.
     *
     * @param name  The name of the file/assembly name to load.
     * @param cai   The information to use when creating new Assembly object.
     *              (Each dependent assembly must be opened to determine its
     *              dependancies, recursively.  This information will be used
     *              for <i>all</i> Assemblies loaded.)
     */
