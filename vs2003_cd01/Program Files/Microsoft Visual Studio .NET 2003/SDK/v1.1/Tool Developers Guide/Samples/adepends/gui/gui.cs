...
namespace ADepends
  ...
  internal class DependencyNode : TreeNode
     ...
     *
     * @param name  The text to display in the TreeView for this node
     * @param d     The object to associate with this node.
     */
  ...
  internal class DependenciesForm : ExplorerForm
     ...
     *
     * @param ad  Where to get the IAssemblyInfo for the Assembly ``name''.
     * @param name  The name of the Assembly to build a tree for.
     * @param o   Contains a list of already observed Assemblies.  This
     *    prevents us from inserting a node for an Assembly more than
     *    once (e.g. for mscorlib, which *everything* is dependant upon,
     *    and thus would otherwise be duplcated several times).
     */
     ...
     *
     * @param name  The name of the activated assembly.
     */
