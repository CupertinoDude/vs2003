...
namespace Windows.FormsUtils
  ...
  internal class ListItemComparer : IComparer
     ...
     *
     * @param column  The column of the ListView to compare.
     * @param dir   The order to compare.  If ``dir'' is true,
     *  then ``x < y'' is returned; otherwise, ``y < x'' is returned.
     *
     * @see Compare
     */
  ...
  internal class InformationPanel : Panel
     ...
     *
     * @param o Object to get the property information from
     ...
     *
     * @return  The height of a TextBox.
     */
     ...
     * label.
     *
     * @param s The text to use in the Label
     * @param lv  The ListView to add to the Panel
     */
