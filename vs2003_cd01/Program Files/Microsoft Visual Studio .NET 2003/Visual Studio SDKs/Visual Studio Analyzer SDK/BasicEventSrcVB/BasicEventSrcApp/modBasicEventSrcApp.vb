 Namespace BasicEventSrcApp
    ...
    Module modBasicEventSrcSetup
        ...
        Public Const PARAM_CausalityID As String = "CasualityID"
        ...
        Public Const DEBUG_EVENT_CATEGORY_STARTSTOP As String = "{6c736d82-BCBF-11D0-8A23-00AA00B58E10}"
        'Function call/return
        Public Const DEBUG_EVENT_CATEGORY_CALLRETURN As String = "{6c736d83-BCBF-11D0-8A23-00AA00B58E10}"
        'Query start and completion
        Public Const DEBUG_EVENT_CATEGORY_QUERYRESULT As String = "{6c736d84-BCBF-11D0-8A23-00AA00B58E10}"
        'Transactional events.
        Public Const DEBUG_EVENT_CATEGORY_TRANSACTION As String = "{6c736d85-BCBF-11D0-8A23-00AA00B58E10}"
        'All events.
        Public Const DEBUG_EVENT_CATEGORY_ALL As String = "{6c736d86-BCBF-11D0-8A23-00AA00B58E10}"
        'All measured
        Public Const DEBUG_EVENT_CATEGORY_MEASURED_ALL As String = "{6c736d87-BCBF-11D0-8A23-00AA00B58E10}"
