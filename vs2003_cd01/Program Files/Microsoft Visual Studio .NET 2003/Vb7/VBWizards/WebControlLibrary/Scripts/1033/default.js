...
function OnFinish(selProj, selObj)
{
    ...
    try
    {
        ...
        var strTemplateFile = strTemplatePath + "\\WebControl.vbproj"; 
        ...
        if( project )
        {
            ...
            strTemplateFile = strTemplatePath + "\\WebControl.vb"; 
            item = AddFileToVSProject("WebCustomControl1.vb", project, project.ProjectItems, strTemplateFile, false);
            if( item )
            {
                item.Properties("SubType").Value = "Code";
