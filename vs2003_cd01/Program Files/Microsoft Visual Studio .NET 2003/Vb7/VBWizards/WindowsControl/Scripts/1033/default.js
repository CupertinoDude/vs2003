...
function OnFinish(selProj, selObj)
{
    ...
    try
    {
        ...
        var strTemplateFile = strTemplatePath + "\\WindowsControl.vbproj"; 
        ...
        if( project )
        {
            ...
            strTemplateFile = strTemplatePath + "\\UserControl.vb"; 
            item = AddFileToVSProject("UserControl1.vb", project, project.ProjectItems, strTemplateFile, false);
            if( item )
            {
