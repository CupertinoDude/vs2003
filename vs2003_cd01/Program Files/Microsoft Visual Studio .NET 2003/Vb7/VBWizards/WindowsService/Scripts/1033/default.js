...
function OnFinish(selProj, selObj)
{
    ...
    try
    {
        ...
        var strTemplateFile = strTemplatePath + "\\WindowsService.vbproj"; 
        ...
        if( project )
        {
            ...
            item = AddFileToVSProject("Service1.vb", project, project.ProjectItems, strTemplateFile, false);
            if( item )
            {
                item.Properties("SubType").Value = "Component";
                project.Properties("StartupObject").Value = project.Properties("RootNamespace").Value + ".Service1";
