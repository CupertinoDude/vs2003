...
Namespace WindowsApplication1
    ...
    Public Class ServiceControllerManager
        ...
        Private Sub lstSrv_SelectedIndexChanged(ByVal Sender As Object, ByVal e As System.EventArgs)
        ...
        Private Sub lstSrv_MouseDown(ByVal Sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        ...
        Private Sub MenuStart(ByVal Sender As Object, ByVal e As EventArgs)
            ...
            Try
                ...
                Else
                    MsgBox(TempSC.ServiceName + " Cannot be started")
                End If
            Catch ex As Exception
                MsgBox("Service: " + DisplayName + " Could not be started ! ")
            End Try
        End Sub 'MenuStart
        ...
        Private Sub MenuStop(ByVal Sender As Object, ByVal e As EventArgs)
            ...
            Try
                If TempSC.CanStop Then
                    ...
                    Catch
                        MsgBox("The service: " + TempSC.DisplayName + " is not allowed to be stopped !")
                    End Try
                Else
                    MsgBox("The service: " + TempSC.DisplayName + " is not allowed to be stopped !")
                End If
        ...
        Private Sub ShowServiceInfo(ByVal Sender As Object, ByVal e As EventArgs)
