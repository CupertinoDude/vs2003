...
Namespace WindowsApplication1
    ...
    Public Class DriverControllerManager
        ...
        Private Sub lstDrv_SelectedIndexChanged(ByVal Sender As Object, ByVal e As System.EventArgs)
            ListCurrent = CType(Sender, ListBox)
            If Not ListCurrent.SelectedItem Is Nothing Then
        ...
        Private Sub lstDrv_MouseDown(ByVal Sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        ...
        Private Sub MenuStart(ByVal Sender As Object, ByVal e As EventArgs)
            ...
            Try
                ...
                If TempServiceController.Status = ServiceControllerStatus.Running Then
                    ...
                    ListDrvRun.Refresh()
                Else
                    MsgBox(TempServiceController.ServiceName + " Cannot be started")
                End If
            Catch
                MsgBox("Service: " + TempServiceController.ServiceName + " Could not be started ! ")
            End Try
        End Sub 'MenuStart
        ...
        Private Sub MenuStop(ByVal Sender As Object, ByVal e As EventArgs)
            ...
            Try
                If TempServiceController.CanStop Then
                    ...
                    Catch
                        MsgBox("The service: " + TempServiceController.DisplayName + " is not allowed to be stopped !")
                    End Try
                Else
                    MsgBox("The service: " + TempServiceController.DisplayName + " is not allowed to be stopped !")
                End If
        ...
        Private Sub MenuPause(ByVal Sender As Object, ByVal e As EventArgs)
            ...
            Catch
                MsgBox("Service: " + DisplayName + " Could not be paused !")
            End Try
        End Sub 'MenuPause
        ...
        Private Sub ShowDriverInfo(ByVal Sender As Object, ByVal e As EventArgs)
            Dim TempServiceController As System.ServiceProcess.ServiceController
            TempServiceController = New System.ServiceProcess.ServiceController
            TempServiceController.MachineName = MachineName
            TempServiceController.DisplayName = DisplayName
