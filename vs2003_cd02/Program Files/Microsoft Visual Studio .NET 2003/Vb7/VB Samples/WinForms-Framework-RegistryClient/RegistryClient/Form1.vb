...
#End Region
    ...
    Private Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        ...
        Try
            ...
            MsgBox("Registry Key " & Reg.Name & " was created.", , "Registry Client")
        Catch ex As Exception
            'Add your error handling here.
            MsgBox("Error: " & """" & ex.Message & """", MsgBoxStyle.Critical, "Registry Client")
        End Try
    ...
    Private Sub btnSet_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSet.Click
        ...
        Try
            ...
            'Let the user know it's done.
            MsgBox("Registry Value " & txtEntry.Text & " - " & txtValue.Text & " saved.", , "Registry Client")
            'close the key
            Reg.Close()
        Catch ex As Exception
            'Add your error handling here.
