...
#End Region
    ...
    Private Sub cmbCallWebService_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCallWebService.Click
        ...
        Else
            Try
                ...
                MsgBox("Return Value: " & WebServ.DoSomeWork(Int32.Parse(txtDelay.Text)), , "Synchronous Call")
    ...
    Private Delegate Function myAsyncDelegate(ByVal intReturn As Integer) As Integer
    ...
    Private Sub cmdWebServAsync_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdWebServAsync.Click
        ...
        Else
            Try
                ...
                MsgBox("Async call started", , "Asynchronous Call")
            Catch ex As Exception
                MsgBox(ex.Message, MsgBoxStyle.Critical)
            End Try
        End If
    ...
    Private Shared Sub MyCallBack(ByVal ar As System.IAsyncResult)
        ...
        MsgBox("Asynchronous response has returned with the value: " & CStr(ReturnValue))
