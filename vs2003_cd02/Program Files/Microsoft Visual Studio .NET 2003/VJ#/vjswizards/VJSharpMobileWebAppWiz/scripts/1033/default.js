...
function OnFinish(selProj, selObj)
{
    ...
    try
    {
        ...
        strTemplateFile = "VJSharpMobileWebAppWiz\\Templates\\" + dte.LocaleID + "\\defaultwebproject.vjsproj"; 	
        var project = CreateBJProject(strProjectName, strProjectPath, strTemplateFile);
        ...
        if( project )
        {
            ...
            strTemplateFile = strTemplatePath + "\\AssemblyInfo.jsl"; 
            item = AddFileToVSProject("AssemblyInfo.jsl", project, project.ProjectItems, strTemplateFile, false);
            if( item )
            {
...
//            AddDefaultWebFormsPropertiesToWizard(dte, wizard, project);
            strTemplateFile = strTemplatePath + "\\MobileWebForm1.aspx.jsl";
            var subItem = AddFileToVSProject("MobileWebForm1.aspx.jsl", project, project.ProjectItems, strTemplateFile, false);
