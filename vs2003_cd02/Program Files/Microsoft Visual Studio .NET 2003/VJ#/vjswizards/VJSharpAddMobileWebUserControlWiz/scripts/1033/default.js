...
//        AddDefaultWebFormsPropertiesToWizard(dte, wizard, selProj);
        ...
        strTemplateFile = strTemplatePath + "\\MobileWebUserControl.ascx.jsl"; 
        var subItem = AddFileToVSProject(strItemName + ".jsl", selProj, selObj, strTemplateFile, false);

        strTemplateFile = strTemplatePath + "\\MobileWebUserControl.ascx"; 
...
{
    var index = fileName.lastIndexOf(".ascx");
    if(index >= 0)
    {
