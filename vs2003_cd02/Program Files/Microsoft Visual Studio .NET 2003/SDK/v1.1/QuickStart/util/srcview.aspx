<%@ Register TagPrefix="Acme" TagName="SourceCtrl" Src="/quickstart/util/SrcCtrl.ascx"%>
              ...
              while ((line = sr.ReadLine()) != null) {
                  ...
                  for (int i=0; i<sourcelist.Length; i++) {
                      ...
                      if (sourcegroup == "VS.NET") {
                          ...
                          {
                              sb.Append("<a href='file:///" +  fullPath + "'>");
                          }
                          ...
                          if (listonly)
                              ...
                              sb.Append("<a href='/quickstart/util/srcview.aspx?path="
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    <form id="Form" runat="server">
        <div class="SampleHeader" style="width:<%=width%>">
            ...
            <table id="SourceTable" EnableViewState="true" style="font: x-small Verdana" runat="server"/>
        </div>
