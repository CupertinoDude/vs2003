<%@ Page CodeBehind="datalist6.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Customize.Vb.datalist6" %>
          ...
          <EditItemTemplate>
            ...
            <table cellpadding=10 style="font: 10pt verdana" >
              <tr>
                ...
                <td valign="top">
                  <b>Title: </b>
                  <asp:linkbutton Font-Bold Text='<%# DataBinder.Eval(Container.DataItem, "title") %>' CommandName="Select" style="color:darkred" runat="server"/>
                  <br>
                  <b>Price: </b><%# DataBinder.Eval(Container.DataItem, "price", "$ {0}") %>
                  <br>
                  <asp:linkbutton Text="Discussions" Command="Discuss" style="color:darkred;font:8pt tahoma" runat="server"/>
                  |
                  <asp:linkbutton Text="Ratings" Command="Ratings" style="color:darkred;font:8pt tahoma" runat="server"/>
                </td>
              </tr>
            </table>
