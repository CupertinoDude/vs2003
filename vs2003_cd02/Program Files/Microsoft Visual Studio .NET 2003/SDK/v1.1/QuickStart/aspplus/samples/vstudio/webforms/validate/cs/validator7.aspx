<%@ Page clienttarget="downlevel" CodeBehind="validator7.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Validate.Cs.validator7" %>
...
<form runat="server">
    ...
    <tr>
      <td></td>
      <td>
        <ASP:Button text="Validate" id="ValidateBtn" runat=server />
      </td>
      <td></td>
    </tr>
    </table>
