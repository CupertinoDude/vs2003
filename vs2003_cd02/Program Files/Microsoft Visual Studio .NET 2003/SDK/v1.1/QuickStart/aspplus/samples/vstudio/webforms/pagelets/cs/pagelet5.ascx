<%@ Control CodeBehind="pagelet5.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Pagelets.Cs.UserControls.pagelet5"%>
<table style="background-color:<%=BackColor%>;font: 10pt verdana;border-width:1;border-style:solid;border-color:black;" cellspacing=15>
  ...
  <tr>
    <td></td>
    <td><ASP:Button Text="Submit" id="SubmitBtn" OnServerClick="Submit_Click" runat="server"/></td>
  </tr>
  <tr>
