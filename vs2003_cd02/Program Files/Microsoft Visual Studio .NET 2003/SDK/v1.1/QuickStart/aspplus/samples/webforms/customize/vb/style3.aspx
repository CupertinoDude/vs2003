...
<body>
  ...
  <form runat="server">
      ...
      Enter some text: <p>
      <input id="MyText" type="text" value="One, Two, Three" style="font: 14pt verdana;background-color:yellow;border-style:dashed;border-color:red;width:300px;" runat="server"/>
