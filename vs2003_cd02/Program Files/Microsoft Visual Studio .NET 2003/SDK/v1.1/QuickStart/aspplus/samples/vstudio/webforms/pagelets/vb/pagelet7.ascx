<%@ Control CodeBehind="pagelet7.ascx.vb" Language="vb" AutoEventWireup="false" Inherits="Pagelets.Vb.UserControls.pagelet7"%>
<span style="font: 12pt verdana">Category:<%=Category%>
</span>
