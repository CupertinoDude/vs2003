...
<script language="JScript" runat="server">
    ...
    public function GetStateIndex(stateName : String) : int
    {
        if (StateIndex[stateName] != null)
            return Int32.Parse(StateIndex[stateName]);
        else
            return 0;
    }
    ...
    >
      ...
      <Columns>
        ...
        <asp:TemplateColumn HeaderText="state" SortExpression="state">
          ...
          <EditItemTemplate>
            <asp:DropDownList runat="server" SelectedIndex='<%# GetStateIndex(DataBinder.Eval(Container.DataItem, "state")) %>' id="edit_State">
