<%@ Page CodeBehind="validator1.aspx.cs" Language="c#" AutoEventWireup="false" Inherits="Validate.Cs.validator1" %>
...
<form runat="server">
    ...
    <tr valign="top">
      <td colspan=3>
        <asp:Label ID="lblOutput" Text="Fill in the required fields below" ForeColor="red" Font-Name="Verdana" Font-Size="10" runat=server />
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <asp:RequiredFieldValidator id="RequiredFieldValidator3"
          ...
          Display="Static"
          InitialValue="" Width="169" runat=server>
          *
        </asp:RequiredFieldValidator>
      </td>
      <td></td>
