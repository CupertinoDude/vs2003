<%@ Control Language="C#" Inherits="FavoriteLinksLeft" Src="FavoriteLinksLeft.cs" Description="Favorite Links UI Module" %>
...
<Portal:LeftModuleHeader Title="Favorite Links" ModuleSource="Modules\FavoriteLinks\FavoriteLinksLeft.ascx" EditPage="/QuickStart/aspplus/samples/portal/CS/modules/favoritelinks/favoritelinks_edit.aspx?side=Left" runat="server"/>
