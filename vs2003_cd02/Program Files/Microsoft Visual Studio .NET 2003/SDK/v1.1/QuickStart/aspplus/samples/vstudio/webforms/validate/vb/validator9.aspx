<%@ Page CodeBehind="validator9.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Validate.Vb.validator9" %>
<html>
<body>
    ...
    <tr>
      ...
      <td>
        <asp:TextBox id=txtFn maxlength=20 width=200px runat=server />
      </td>
      <td>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <asp:TextBox id=txtLn maxlength=40 width=200px runat=server />
      </td>
      <td>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <asp:TextBox id=txtAddress width=200px runat=server />
      </td>
      <td>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <asp:TextBox id=txtState width=30px maxlength=2 runat=server />&nbsp;
        <font face=Arial size=2>Zip Code:</font>&nbsp;
        <ASP:TextBox id=txtZip width=60px maxlength=5 runat=server />
      </td>
      <td>
