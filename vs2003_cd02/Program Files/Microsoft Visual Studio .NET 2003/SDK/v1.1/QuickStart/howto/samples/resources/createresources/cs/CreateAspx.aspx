...
12.	From the <A HREF="/quickstart/util/srcview.aspx?path=/quickstart/howto/samples/resources/createresources/CreateAspxRes.src">code source links</A> page, click the link to the file called "createAspxRes.aspx" (make sure it is the CS Version). 
	copy the entries and paste them into the file you just made. Save and close the file. Once done, 
	come back to complete the following steps.
