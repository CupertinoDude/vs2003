...
{    
    public static string Go()
    {
        ...
        Console.WriteLine("After populating our list, its Count is {0} " +
            "and its Capacity is {1}", al.Count, al.Capacity);
        ...
        //remove the MyType. Remember, we just removed intTemp, 
        ...
        //display the count, and capacity
        Console.WriteLine("After modifying our list, its Count is {0} " +
            "and its Capacity is {1}", al.Count, al.Capacity);
        ...
        //we can use a String object in our foreach statement. 
        //If you are at all uncertain, use foreach (Object item in al)
        ...
        //display the count, and capacity
        Console.WriteLine("After removing all elements from our list, " +
...
<body style="background-color:f6e4c6">
    ...
    Elements are added to, and removed from the list through the use of 
    the methods and properties in the ArrayList. To iterate over the list, 
    use a foreach statement, which can identify each object in the list in turn.
    <hr>
    </td></tr>
