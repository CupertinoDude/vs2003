                ...
                <tr>
                    <td>
                        <b>The following example walks you through the process of creating a 
                            resources-aware application, for a console application</b> . The purpose of 
                        this demonstration is to make you more familiar with the steps required to 
                        create and use resources. It is not intended to show you how to write the code 
...
4.	From the <A HREF="/quickstart/util/srcview.aspx?path=/quickstart/howto/samples/resources/useresources/useresources.src">code source links</A> page, click the link to the file called "strings.txt". 
...
6.	Create a new file in the same directory called myApp.cs, and open that file for
	editing ("notepad myApp.cs"). When asked, create the file (click Yes).

7.	From the <A HREF="/quickstart/util/srcview.aspx?path=/quickstart/howto/samples/resources/useresources/useresources.src">code source links</A>  page, click the link to the file called "myApp.cs". copy 
...
8.	Compile your main assembly, linking in your resources file, with the following
	command: "csc /t:exe /res:strings.resources myApp.cs"
...
12.	From the <A HREF="/quickstart/util/srcview.aspx?path=/quickstart/howto/samples/resources/useresources/useresources.src">code source links</A> page, click the link to the file called "strings.en-NZ.txt". 
...
16.	Repeat steps 10 - 15 for any other cultures you wish to include, changing the culture
	...
	that for this particular demonstration, if you want to add a brand new culture, you will also 
	need to modify the .cs file and recompile your main assembly (see step 8) to recognize the 
	new culture. Normally, you would not request the user for a specific culture: they would set 
	it via Control Panel/Regional Options.
<p><hr>
