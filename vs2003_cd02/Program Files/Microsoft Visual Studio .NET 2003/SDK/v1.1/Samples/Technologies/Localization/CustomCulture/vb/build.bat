...
vbc %DEBUGSAMPLE% /out:CustomCulture.exe /target:winexe /r:system.dll /r:system.drawing.dll /r:system.windows.forms.dll /r:system.data.dll /r:system.XML.dll /res:CustomCulture.MainForm.resources MainForm.vb customCulture.vb