@ECHO OFF
CLS
SET BLDCTRL_DLL=ClockControl.dll
SET BLDCTRL_SRC=ClockControl\ClockControl.cs
SET BLDCTRL_ASM=ClockControl\AssemblyInfo.cs
SET BLDCTRL_SLN=WorldClock.sln
...
ECHO.
ECHO ---------------------------------
ECHO ClockControl setup for WorldClock
ECHO ---------------------------------
ECHO.
