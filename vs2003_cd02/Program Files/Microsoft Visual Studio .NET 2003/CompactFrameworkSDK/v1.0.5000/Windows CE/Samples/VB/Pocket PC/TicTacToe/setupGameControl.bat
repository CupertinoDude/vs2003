@ECHO OFF
CLS
SET BLDCTRL_DLL=GameControl.dll
SET BLDCTRL_SRC=GameControl\GameControl.cs
SET BLDCTRL_ASM=GameControl\AssemblyInfo.cs
SET BLDCTRL_PFX=Designer
SET BLDCTRL_SLN=TicTacToe.sln
...
ECHO.
ECHO -------------------------------
ECHO GameControl setup for TicTacToe
ECHO -------------------------------
ECHO.
